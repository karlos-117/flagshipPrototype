var w = c.width = window.innerWidth,
      ...
      // '#0686cb'
      // #2162a2
			connectionColor: 'hsla(194,17%,76%,alp)',
      // connectionColor: 'hsla(200,60%,light%,alp)',

			rootColor: 'hsla(44,100%,60%)',
      // rootColor: 'hsla(212,60%,light%,alp)',

			endColor: 'hsla(31,100%,47%,alp)',
      // endColor: 'hsla(160,20%,light%,alp)',

			dataColor: 'hsla(40,80%,80%,alp)',
			
			wireframeWidth: 0.7,
			wireframeColor: '#2162a2', 
      // #2162a2
      // #99cef8f
...
Connection.prototype.draw = function(){
  ...
  // ctx.fillRect(this.screen.x - this.screen.scale * this.size * 2.5/2, this.screen.y - this.screen.scale * this.size * 2.5/2, this.screen.scale * this.size * 2.5, this.screen.scale * this.size * 2.5);
  ctx.roundRect(this.screen.x - this.screen.scale * this.size * 2.5/2, this.screen.y - this.screen.scale * this.size * 2.5/2, this.screen.scale * this.size * 2.5, this.screen.scale * this.size * 2.5, 2);
  // ctx.roundRect(0, 0, 200, 100, 8);
  ctx.strokeStyle = 'black',
  // ctx.strokeStyle = '#2162a2',
  ctx.lineWidth = 1,
  ctx.stroke();
  ctx.fill();
